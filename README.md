...
2. [:film_strip: \[rus\] SOLID principles & Architecture: a lecture from FPMI](https://www.youtube.com/watch?v=XjGbg-N4sQc&t=1393s)
...
## OOP
1. [:film_strip: \[eng\] OOP explained by Mosh](https://www.youtube.com/watch?v=pTB0EiLXUC8)
2. [:scroll: \[eng\] Why OOP is not a silver bullet](https://medium.com/@cscalfani/goodbye-object-oriented-programming-a59cda4c0e53)
3. [:scroll: \[eng\] Inheritance vs Composition. Which should you use?](https://medium.com/better-programming/inheritance-vs-composition-2fa0cdd2f939) 
...
# IDEs
## IntelliJ Idea
1. [:film_strip: \[eng\] IntelliJ Idea Full Course by
Amigoscode
...
3. [:film_strip: \[eng\] Bash tutorial (we use zsh with a lot of plugins but most of what is shown in this video still applies)](https://www.youtube.com/watch?v=oxuRxtrO2Ag)
...
## Apache Ignite
1. [:film_strip: \[eng\] Getting started with Apache Ignite part 1](https://www.youtube.com/watch?v=3dpHqlRhELI)
...
2. [:scroll: \[eng\] Usage of Mockito](https://medium.com/art-of-coding/usage-of-mockito-674db441a334)
3. [:scroll: \[eng\] Mocking with Mockito: advanced techniques](https://medium.com/trabe/mocking-with-mockito-advanced-techniques-3a4e5143c2ba)
...
2. [:scroll: \[eng\] Serenity BDD official documntation](http://serenity-bdd.info/docs/serenity/)
...
2. [:film_strip: \[eng\] React in 30 minutes](https://www.youtube.com/watch?v=hQAHSlTtcmY)
3. [:film_strip: \[eng\] Learn useState In 15 Minutes - React Hooks Explained](https://www.youtube.com/watch?v=O6P86uwfdR0&list=PLZlA0Gpn_vH8EtggFGERCwMY5u5hOjf-h)
4. [:film_strip: \[eng\] Learn useEffect In 13 Minutes](https://www.youtube.com/watch?v=0ZJgIjIuY7U)
5. [:film_strip: \[eng\] Redux Tutorial - Learn Redux from Scratch](https://www.youtube.com/watch?v=poQXNp9ItL4)
6. [:film_strip: \[eng\] React Unit Testing](https://www.youtube.com/watch?v=3e1GHCA3GP0)
